...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  flinterDecisionTrace: 'extensions.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  SessionArchiveEvent: 'persistence.md',
  SessionArchivePage: 'persistence.md',
  SessionArchiveSnapshot: 'persistence.md',
  ...
  CreateWorktreeOptions: 'workspace.md',
  ...
  WorkspaceWorktreeRecord: 'workspace.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  DiagnosticCode: 'capture failure diagnostic code union is owned by packages/flinter/dsh-decision-trace/README.md',
