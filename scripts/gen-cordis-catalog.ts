...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  sourceController: 'web-server.md',
  relace: 'extensions.md',
  flinterPacketEvidence: 'extensions.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  sourceDrafts: 'client-side source-draft Remote facade — packages/api/source-controller/README.md owns the API',
  sourcePublisher: 'optional host-side Git/PR publisher — packages/host/source-publisher-github/README.md owns the API',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  SourceDraftBootstrapRequest: 'source draft bootstrap request contract is owned by packages/api/source-controller/README.md',
  SourceDraftBootstrapResult: 'source draft bootstrap result contract is owned by packages/api/source-controller/README.md',
  SourceDraftListRequest: 'source draft list request contract is owned by packages/api/source-controller/README.md',
  SourceDraftListResult: 'source draft list result contract is owned by packages/api/source-controller/README.md',
  SourceDraftGetRequest: 'source draft get request contract is owned by packages/api/source-controller/README.md',
  SourceDraftGetResult: 'source draft get result contract is owned by packages/api/source-controller/README.md',
  SourceDraftSaveRequest: 'source draft save request contract is owned by packages/api/source-controller/README.md',
  SourceDraftSaveResult: 'source draft save result contract is owned by packages/api/source-controller/README.md',
  SourceDraftDeleteRequest: 'source draft delete request contract is owned by packages/api/source-controller/README.md',
  SourceDraftDeleteResult: 'source draft delete result contract is owned by packages/api/source-controller/README.md',
  SourceDraftPublishRequest: 'source draft publish request contract is owned by packages/api/source-controller/README.md',
  SourceDraftPublishResult: 'source draft publish result contract is owned by packages/api/source-controller/README.md',
  WebActivitySnapshot: 'host transport activity snapshot contract is owned by packages/host/webserver/README.md',
  RelaceSearchToolBridge: 'Relace Search bridge contract is owned by packages/extensions/relace/README.md',
  RelaceSearchToolHandlers: 'Relace Search handler contract is owned by packages/extensions/relace/README.md',
