...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  InvestigationState: 'agentic-control durable state is owned by packages/agentic-control/agentic-control/README.md',
  PhysicalAssessmentProvider: 'agentic-control provider contract is owned by packages/agentic-control/agentic-control/README.md',
  PhysicalAssessmentResult: 'agentic-control provider result contract is owned by packages/agentic-control/agentic-control/README.md',
  StartInvestigationRequest: 'agentic-control privileged start contract is owned by packages/agentic-control/agentic-control/README.md',
