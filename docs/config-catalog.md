...
Depends on: [`PiAiModelProfile`](../packages/llm/llm-pi-ai/src/index.ts)

Source: [`packages/llm/llm-workbuddy/src/config.ts:31`](../packages/llm/llm-workbuddy/src/config.ts)
...
Depends on: [`DecisionRef`](../packages/flinter/dsh-decision-trace/src/index.ts) · [`DecisionStatus`](../packages/flinter/dsh-decision-trace/src/index.ts) · [`Disposition`](../packages/flinter/dsh-decision-trace/src/index.ts) · [`ToolExecution`](subsystems/tools.md) · [`ToolExecutionResult`](subsystems/tools.md)

Source: [`packages/flinter/dsh-segmentation-decision-trace/src/index.ts:191`](../packages/flinter/dsh-segmentation-decision-trace/src/index.ts)
...
- `@deepseek-ai/dsh-decision-trace` — requires `tools` ([`packages/flinter/dsh-decision-trace/src/index.ts`](../packages/flinter/dsh-decision-trace/src/index.ts))
