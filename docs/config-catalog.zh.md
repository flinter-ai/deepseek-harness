...
来源：[`packages/agentic-control/agentic-control/src/index.ts:53`](../packages/agentic-control/agentic-control/src/index.ts)
...
来源：[`packages/llm/llm-pi-ai/src/config.ts:182`](../packages/llm/llm-pi-ai/src/config.ts)
...
- `@deepseek-ai/dsh-tool-agentic-control` — 需要 `agents` · `investigations` · `tools` · `systemPrompt`（[`packages/agentic-control/tool-agentic-control/src/index.ts`](../packages/agentic-control/tool-agentic-control/src/index.ts)）
